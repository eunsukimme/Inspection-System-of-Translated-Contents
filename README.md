# Inspection System of Translated Contents(ISTC)

Hyperledger기반 번역 콘텐츠 검수 시스템

## Table of contents

- [What is ISTC](#what-is-ISTC)
...
하이퍼레저 패브릭에 ISTC business network를 배포하기 위해선 peer에 해당 네트워크를 설치해야 하며, 그런 다음 business network를 시작할 수 있습니다.
...
\
ISTC network를 설치하기 위해, qa-network 경로에서 다음 명령을 실행해 줍니다.
...
자, 이제 ISTC network가 정상적으로 배포되었는지 확인하기 위해 다음 명령을 실행해 줍니다.
...
\
Connect Now를 클릭하면 Playground 에서 ISTC network를 확인할 수 있습니다! Define 탭에서 network 모델을 확인할 수 있습니다.\
\
...
\
Test 탭에서는 ISTC network의 transaction을 직접 생성하면서 테스트할 수 있습니다. \
\
...
ISTC의 Participant, Asset, Transaction에 대한 자세한 설명은 [API Reference](https://github.com/eunsukimme/Translation-Content-Quality-Assurance-System/wiki/API-Reference)를 참고하세요.
...
ISTC는 부경대 링크플러스 사업단의 지원을 받아 수행되었습니다.
